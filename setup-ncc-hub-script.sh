...
gcloud network-connectivity spokes create $SPOKE_BO1 \
    --hub=$NCC_HUB \
...
gcloud network-connectivity spokes create $SPOKE_BO2 \
    --hub=$NCC_HUB \
...
echo ""
echo "Spokes:"
gcloud network-connectivity spokes list --hub=$NCC_HUB
